...
Constraint output is applied only to `ObjectRuntime::clarity_transform.evaluated`.
`Object::clarity_transform` remains the authored, serialized and animatable source.
