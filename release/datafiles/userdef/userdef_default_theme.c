...
const bTheme U_theme_default = {
  ...
  .space_view3d = {
    ...
    .grid_major = RGBA(0x2c2c2cff),
    .grid_axis_brightness = 0.0f,
    .wire = RGBA(0x000000ff),
    .wire_edit = RGBA(0x000000ff),
    .select = RGBA(0xffffffff),
    .lamp = RGBA(0x00000050),
    .speaker = RGBA(0x000000ff),
    .empty = RGBA(0x000000ff),
    .camera = RGBA(0x000000ff),
    .active = RGBA(0x00ff00ff),
    .transform = RGBA(0xffffffff),
    .vertex = RGBA(0x000000ff),
    .vertex_select = RGBA(0xff0000ff),
    .edge = RGBA(0x000000ff),
    .edge_select = RGBA(0xff0000ff),
    .edge_mode_select = RGBA(0xff3030ff),
    .face = RGBA(0xffffff02),
    .face_select = RGBA(0xff000033),
    .face_mode_select = RGBA(0xff303033),
    ...
    .obcenter_dia = 6,
    .facedot_size = 3,
    .editmesh_active = RGBA(0xff6060ff),
  ...
  .space_outliner = {
    ...
    .selected_object = RGBA(0xffffffff),
    .active_object = RGBA(0x00ff00ff),
