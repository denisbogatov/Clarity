...
/** Maya soft-selection false color: unlike generic extras, color interpolates along every edge. */
GPU_SHADER_INTERFACE_INFO(overlay_soft_selection_wire_iface)
FLAT(float2, edge_start)
NO_PERSPECTIVE(float2, edge_pos)
SMOOTH(float4, final_color)
GPU_SHADER_INTERFACE_END()

GPU_SHADER_CREATE_INFO(overlay_soft_selection_wire)
DO_STATIC_COMPILATION()
VERTEX_OUT(overlay_soft_selection_wire_iface)
FRAGMENT_OUT(0, float4, frag_color)
FRAGMENT_OUT(1, float4, line_output)
VERTEX_SOURCE("overlay_soft_selection_wire_vert.glsl")
FRAGMENT_SOURCE("overlay_soft_selection_wire_frag.glsl")
TYPEDEF_SOURCE("overlay_shader_shared.hh")
STORAGE_BUF(0, read, VertexData, data_buf[])
...
CREATE_INFO_VARIANT(overlay_soft_selection_wire_clipped, overlay_soft_selection_wire, drw_clipped)

GPU_SHADER_INTERFACE_INFO(overlay_soft_selection_point_iface)
FLAT(float4, final_color)
GPU_SHADER_INTERFACE_END()

GPU_SHADER_CREATE_INFO(overlay_soft_selection_point)
DO_STATIC_COMPILATION()
VERTEX_OUT(overlay_soft_selection_point_iface)
FRAGMENT_OUT(0, float4, frag_color)
FRAGMENT_OUT(1, float4, line_output)
VERTEX_SOURCE("overlay_soft_selection_point_vert.glsl")
FRAGMENT_SOURCE("overlay_soft_selection_point_frag.glsl")
TYPEDEF_SOURCE("overlay_shader_shared.hh")
STORAGE_BUF(0, read, VertexData, data_buf[])
PUSH_CONSTANT(float, ndc_offset_factor)
PUSH_CONSTANT(float, ndc_offset)
...
CREATE_INFO_VARIANT(overlay_soft_selection_point_clipped, overlay_soft_selection_point, drw_clipped)
...
PUSH_CONSTANT(float4x4, camera_object_persinv)
