...
DNA_STRUCT_RENAME(MayaAimConstraintSettings, ClarityAimConstraintSettings)
DNA_STRUCT_RENAME(MayaConstraint, ClarityConstraint)
DNA_STRUCT_RENAME(MayaConstraintTarget, ClarityConstraintTarget)
DNA_STRUCT_RENAME(MayaObjectTransform, ClarityObjectTransform)
...
DNA_STRUCT_RENAME_MEMBER(Object, _pad_maya_transform, _pad_clarity_transform)
...
DNA_STRUCT_RENAME_MEMBER(Object, maya_constraints, clarity_constraints)
DNA_STRUCT_RENAME_MEMBER(Object, maya_transform, clarity_transform)
...
DNA_STRUCT_RENAME_MEMBER(UserDef, maya_interaction_defaults_initialized, clarity_interaction_defaults_initialized)
