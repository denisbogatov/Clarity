...
static void rna_def_scene_display(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "matcap_ssao_distance", PROP_FLOAT, PROP_PIXEL);
  RNA_def_property_ui_text(prop, "Radius", "Radius of the ambient occlusion sampling area");
  RNA_def_property_range(prop, 1.0f, 256.0f);
  RNA_def_property_ui_range(prop, 1.0f, 64.0f, 1, 0);
