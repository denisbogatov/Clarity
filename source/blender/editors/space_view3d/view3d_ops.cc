...
void view3d_operatortypes()
{
  ...
  WM_operatortype_append(VIEW3D_OT_clarity_face_centers_toggle);
  WM_operatortype_append(VIEW3D_OT_clarity_wireframe_on_shaded_toggle);
  ...
  WM_operatortype_append(VIEW3D_OT_toggle_clarity_ao);
  WM_operatortype_append(VIEW3D_OT_toggle_maya_ao_compatibility);
