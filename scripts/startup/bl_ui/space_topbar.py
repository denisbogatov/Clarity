...
class _ClarityShelfAction:
    ...
    def _action_tables():
        ...
        # Maya-style shelf primitives are commands that create at the world origin. Keep this
        # explicit so a moved Blender 3D Cursor cannot silently offset a shelf-created object.
        world_origin_add = {
            "align": 'WORLD',
        ...
        operators = {
            "plane": ("mesh.primitive_plane_add", world_origin_add.copy()),
            "cube": ("mesh.primitive_cube_add", world_origin_add.copy()),
            "sphere": ("mesh.primitive_uv_sphere_add", world_origin_add.copy()),
            "cylinder": ("mesh.primitive_cylinder_add", world_origin_add.copy()),
            "cone": ("mesh.primitive_cone_add", world_origin_add.copy()),
            "torus": ("mesh.primitive_torus_add", world_origin_add.copy()),
            "bezier": ("curve.primitive_bezier_curve_add", world_origin_add.copy()),
            "bezier_circle": ("curve.primitive_bezier_circle_add", world_origin_add.copy()),
            "nurbs": ("curve.primitive_nurbs_curve_add", world_origin_add.copy()),
            "nurbs_circle": ("curve.primitive_nurbs_circle_add", world_origin_add.copy()),
            "path": ("curve.primitive_nurbs_path_add", world_origin_add.copy()),
            ...
            "armature": (
                "object.armature_add", {**world_origin_add, "enter_editmode": False},
            ),
            ...
            "camera": ("object.camera_add", world_origin_add.copy()),
            "point_light": (
                "object.light_add", {**world_origin_add, "type": 'POINT'},
            ),
            "area_light": (
                "object.light_add", {**world_origin_add, "type": 'AREA'},
            ),
            "sun_light": (
                "object.light_add", {**world_origin_add, "type": 'SUN'},
            ),
            ...
            "wind": (
                "object.effector_add", {**world_origin_add, "type": 'WIND'},
            ),
            "turbulence": (
                "object.effector_add", {**world_origin_add, "type": 'TURBULENCE'},
            ),
            ...
            "empty": (
                "object.empty_add", {**world_origin_add, "type": 'PLAIN_AXES'},
            ),
